#!/usr/bin/env sh
# Universal installer for dastlite. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/dastlite.git"
echo "Installing dastlite ..."
