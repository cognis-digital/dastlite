"""Native cognis-connect emit for dastlite — forward findings to any platform.

Maps dastlite's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    dastlite ... --format json | dastlite-emit --to stix
    dastlite-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
